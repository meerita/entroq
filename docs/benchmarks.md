...
Source: a gate-tier campaign sealed at one revision, 48 of 48 segments, 506 seconds. It holds
...
| Codec | Point | Ratio | Compressed bytes | Encode MB/s | Encode spread | Decode MB/s | Decode spread |
|---|---|---:|---:|---:|---:|---:|---:|
| Entroq | `fast` | 1.000 | 1048674 | 2055.0 | 0.017 | 20132.8 | 0.099 |
| Entroq | `balanced` | 1.000 | 1048674 | 889.5 | 0.053 | 20245.9 | 0.113 |
...
project-high-entropy-medium at 2 055 MB/s and BALANCED at 890 MB/s, where LZ4 `fast-1` reaches
29 607 MB/s and Snappy 33 825 MB/s. A block whose bytes are all equal is stored as RLE without
...
Known:
- Measured above: FAST at 2 055 MB/s and BALANCED at 890 MB/s on
  incompressible input, against 29 607 MB/s for LZ4 fast-1 and 33 825 MB/s
  for Snappy, a gap of about 14 times for FAST.
